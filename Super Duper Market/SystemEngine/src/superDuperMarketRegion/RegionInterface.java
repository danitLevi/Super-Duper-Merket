...
//                          Map<Integer, Map<OfferDto,Integer>> storeIdToItemsToOrderFromSales);
    ...
    public Integer saveOrderAndReturnId(OrderInputToSaveInSessionDto orderInput, Customer customer);
    ...
    int getNumOfItemsInSystem();
    OrderDto getWantedOrderDetails(int orderId);
}