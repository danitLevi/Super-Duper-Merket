...
//        return getDeliveryPrice(storeId,customer.getLocation());
    ...
    public List<StoreOrderDto> getStoreOrderDetails(int storeId)
    {
        ...
        {
            currOrder=orderIdToOrder.get(currOrderId);
            currStoreOrder=currOrder.getWantedStoreOrder(storeId);
            currStoreOrderDto=currStoreOrder.getStoreOrderDetails(currOrder.getOrderLocation(),this.itemIdToItems);
...
////            isDynamicOredr=true;
////        }
//        Coordinate orderLocaion=order.getOrderLocation();
//
//
...
//                ,storeOrder.getDeliveryPrice(orderLocaion)
//                ,storeOrder.getTotalPrice(orderLocaion),
////                isDynamicOredr,
////                order.getId(),
//                itemsInStoreDetails,
//                storeOrder.getDistanceFromCustomer(orderLocaion)
...
//    }
    ...
    public Set<OrderDto> getRegionOrdersDetails()
    {
        ...
        for (Order currOrder: orderIdToOrder.values())
        {
            currOrderDetails=currOrder.getOrderDetails(this.itemIdToItems);
...
//    }
    ...
    public  int getNumOfItemsInSystem()
    {
     return itemIdToItems.size();
    }

    public OrderDto getWantedOrderDetails(int orderId)
    {
        Order currOrder=orderIdToOrder.get(orderId);
        return currOrder.getOrderDetails(this.itemIdToItems);
    }
}